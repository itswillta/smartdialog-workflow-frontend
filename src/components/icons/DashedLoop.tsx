...
interface DashedLoopIconProps extends JSX.HTMLAttributes<SVGSVGElement> {
  class?: string;
}

const DashedLoopIcon: Component<DashedLoopIconProps> = (props) => {
  const [local, others] = splitProps(props, ['children', 'class']);

  return (
    <svg classList={{ 'svg-icon': true, [props.class]: true }} viewBox="0 0 40 40" aria-hidden="true" {...others}>
      <g>
        <path
          fill="none"
          stroke="currentColor"
        ...
        <path
          ...
          stroke-width="4"
          stroke-miterlimit="10"
          stroke-dasharray="6.2822,1.8847"
          d="M9.4,31.1
        ...
        <path
          ...
          stroke-width="4"
          stroke-miterlimit="10"
          stroke-dasharray="9.8972,2.9692"
          d="M6.1,12
